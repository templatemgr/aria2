    ...
    angular.module('ariaNg').run([
      ...
      function (a, n, s, o, t, i, r, l, e) {
        var c = !1,
          ...
          u = function () {
            (n.currentTheme = 'light'), angular.element('body').removeClass('theme-dark');
          },
          p = function () {
            (n.currentTheme = 'dark'), angular.element('body').addClass('theme-dark');
          },
          g = function () {
            if (l.isBrowserSupportDarkMode()) {
              var e = a.matchMedia('(prefers-color-scheme: dark)');
              r.info('[root.setThemeBySystemSettings] system uses ' + (e.matches ? 'dark' : 'light') + ' theme'), e.matches ? p() : u();
            } else g();
          },
          f = function () {
        ...
        (n.filterTask = function (e) {
          return (
            ...
            (!n.searchContext || !n.searchContext.text || 0 <= e.taskName.toLowerCase().indexOf(n.searchContext.text.toLowerCase()))
          );
        }),
          ...
          leftSwipe: function () {
            l.getSwipeGesture() &&
              (angular.element('body').hasClass('sidebar-open')
                ? f()
                : (!this.extendLeftSwipe || (angular.isFunction(this.extendLeftSwipe) && !this.extendLeftSwipe())) && f());
          },
          rightSwipe: function () {
            l.getSwipeGesture() &&
              (!this.extendRightSwipe || (angular.isFunction(this.extendRightSwipe) && !this.extendRightSwipe())) &&
        ...
        n.$on('$routeChangeStart', function (e, t, a) {
          ...
          (n = i),
            ...
            angular.element('section.sidebar > ul > li.treeview > ul.treeview-menu > li[data-href-match]').each(function (e, t) {
              var a = angular.element(t).attr('data-href-match');
              d(a, n) && angular.element(t).addClass('active').parent().parent().addClass('active');
            }),
            o.unbind('keypress');
        }),
        l.isBrowserSupportDarkMode()) &&
          a.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', function (e) {
            r.info('[root] system switches to ' + (e.matches ? 'dark' : 'light') + ' theme'), 'system' === l.getTheme() && (e.matches ? p() : u());
          });
        n.$on('$locationChangeSuccess', function (e, t) {
          ...
          (function () {
            ...
            if (
              (e.localStroage || r.warn('[root.initCheck] LocalStorage is not supported!'),
          ...
          angular.element('section.sidebar > ul > li[data-href-match] > a').click(function () {
            angular.element('section.sidebar > ul li').removeClass('active'), angular.element(this).parent().addClass('active');
          }),
  ...
  (function () {
    ...
    angular.module('ariaNg').config([
      ...
      function (e, t, a, n, i, s) {
        e.errorOnUnhandledRejections(!1), a.setPrefix(i.appPrefix).setStorageType('localStorage').setStorageCookie(365, '/');
        var o = [],
          r = {};
        for (var l in s)
          ...
          (0 === (t = n).indexOf('/new')
            ? (function (e, t) {
                ...
                var a = {},
                  n = !1;
                if (t) {
                  for (var i in t) t.hasOwnProperty(i) && f.isOptionKeyValid(i) && (a[i] = t[i]);
                  'true' === t.pause && (n = !0);
                }
                return (
                  (s.loadPromise = g.newUriTask({ urls: [e], options: a }, n, function (e) {
            ...
            : (d.showError('Parameter is invalid!'), 0)) || r.path('/downloading');
      },
    ]);
  })(),
  (function () {
      ...
      function (i, s, o, t, r, e, a, n, l, c, d, u, p, g, f, m, h, v) {
          ...
          w = function (e, t) {
            return v.getGlobalStat(function (e) {
              e.success || e.data.message !== c.Unauthorized.message
                ? (e.success && ((s.globalStat = e.data), f.recordGlobalStat(e.data)), t && t(e))
                : a.cancel(y);
            }, e);
          },
          S = function () {
        ...
        g.getBrowserNotification() && u.requestBrowserPermission(),
          ...
          (s.isSelectedTasksAllHaveInfoHash = function () {
            var e = i.taskContext.getSelectedTasks();
            if (e.length < 1) return !1;
            for (var t = 0; t < e.length; t++) if (!e[t].bittorrent || !e[t].infoHash) return !1;
            return !0;
          }),
          (s.isSpecifiedTaskSelected = function () {
            var e = i.taskContext.getSelectedTasks();
            if (e.length < 1) return !1;
            for (var t = 0; t < e.length; t++) for (var a = 0; a < arguments.length; a++) if (e[t].status === arguments[a]) return !0;
            return !1;
          }),
                ...
                function (e) {
                  e.hasError && 1 < a.length && p.showError('Failed to change some tasks state.'),
                    e.hasSuccess &&
                      (w(!0),
                      e.hasError || 'start' !== t
                        ? e.hasError || 'pause' !== t || ('/downloading' === r.path() ? r.path('/waiting') : o.reload())
                        : '/waiting' === r.path()
                        ? r.path('/downloading')
                        : o.reload());
                },
          ...
          (s.isSelectedTaskRetryable = function () {
            var e = i.taskContext.getSelectedTasks();
            if (e.length < 1) return !1;
            for (var t = 0; t < e.length; t++) if (!i.isTaskRetryable(e[t])) return !1;
            return !0;
          }),
          (s.retryTasks = function () {
            ...
            if (e && !(e.length < 1)) {
              ...
              for (var t = [], a = 0, n = 0; n < e.length; n++) i.isTaskRetryable(e[n]) ? t.push(e[n]) : a++;
              p.confirm(
                'Confirm Retry',
                'Are you sure you want to retry the selected task? AriaNg will create same task after clicking OK.',
                'info',
                      ...
                      w(!0),
                        p.showInfo(
                          ...
                          function () {
                            ...
                            t.hasSuccess && ('task-list-downloading' === e && '/downloading' !== r.path() ? r.path('/downloading') : o.reload());
                          },
                          {
                            textParams: {
                ...
                i.loadPromise = h.removeTasks(
                  ...
                  function (e) {
                    e.hasError && 1 < t.length && p.showError('Failed to remove some task(s).'),
                      e.hasSuccess && (w(!0), e.hasError || ('/stopped' !== r.path() ? r.path('/stopped') : o.reload()));
                  },
                  1 < t.length
                );
              };
          ...
          (s.clearStoppedTasks = function () {
            p.confirm('Confirm Clear', 'Are you sure you want to clear stopped tasks?', 'warning', function () {
              i.loadPromise = h.clearStoppedTasks(function (e) {
                e.success && (w(!0), '/stopped' !== r.path() ? r.path('/stopped') : o.reload());
              });
            });
          }),
          ...
          (s.copySelectedTasksDownloadLink = function () {
            for (var e = i.taskContext.getSelectedTasks(), t = '', a = 0; a < e.length; a++) 0 < a && (t += '\n'), (t += e[a].singleUrl);
          ...
          (s.changeDisplayOrder = function (e, t) {
            ...
            t && n.type === a.type && (n.reverse = !a.reverse), g.setDisplayOrder(n.getValue());
          }),
          ...
          (s.switchRpcSetting = function (e) {
            e.isDefault ||
              ...
              0 === r.path().indexOf('/task/detail/') ? (i.setAutoRefreshAfterPageLoad(), r.path('/downloading')) : t.location.reload());
          }),
      ...
      function (l, c, d, e, u, t, a, n, p, g, i) {
        ...
        if (
          ((c.context = {
            ...
            urls: '',
            uploadFile: null,
            availableOptions: ((s = i.getNewTaskOptionKeys()), i.getSpecifiedOptions(s, { disableRequired: !0 })),
            globalOptions: null,
            options: {},
        ...
        (c.changeTab = function (e) {
          ...
          (c.openTorrent = function () {
            n.openFileContent(
              ...
              function (e) {
                (c.context.uploadFile = e), (c.context.taskType = 'torrent'), c.changeTab('options');
              },
              function (e) {
                t.showError(e);
              },
          ...
          (c.openMetalink = function () {
            n.openFileContent(
              ...
              function (e) {
                (c.context.uploadFile = e), (c.context.taskType = 'metalink'), c.changeTab('options');
              },
              function (e) {
                t.showError(e);
              },
            ...
            'urls' === c.context.taskType
              ? (l.loadPromise = (function (e, t) {
                  for (var a = u.parseUrlsFromOriginInput(c.context.urls), n = angular.copy(c.context.options), i = [], s = 0; s < a.length; s++)
                    '' !== a[s] && '' !== a[s].trim() && i.push({ urls: [a[s].trim()], options: n });
          ...
          (c.setOption = function (e, t, a) {
            '' !== t ? (c.context.options[e] = t) : delete c.context.options[e], a.setReady();
          }),
                      ...
                      if (t) (o.taskContext.list = a), (f = !1);
                        ...
                        if (o.taskContext.list && 0 < o.taskContext.list.length)
                          for (var n = 0; n < o.taskContext.list.length; n++) {
                            delete (s = o.taskContext.list[n]).verifiedLength, delete s.verifyIntegrityPending;
                          }
                        f = !c.extendArray(a, o.taskContext.list, 'gid');
                      }
                      if (o.taskContext.list && 0 < o.taskContext.list.length && (d.processDownloadTasks(o.taskContext.list), !t)) {
                        var i = !1;
                        for (n = 0; n < o.taskContext.list.length; n++) {
                          var s;
                          if ((s = o.taskContext.list[n]).hasTaskName || s.files || s.bittorrent) {
                            i = !0;
                            break;
                          }
                        }
                        if (!i) return (f = !0), void (o.taskContext.list.length = 0);
                      }
                      o.taskContext.enableSelectAll = o.taskContext.list && 0 < o.taskContext.list.length;
                    } else e.data.message === l.Unauthorized.message && r.cancel(p);
                },
                e
              );
          };
    ...
    angular.module('ariaNg').controller('TaskDetailController', [
      ...
      function (o, g, e, t, n, a, f, m, r, l, s, c) {
        var i = [
          ...
          p = null,
          h = function () {
            for (var e = [], t = 0; t < i.length; t++) i[t].show && e.push(i[t].name);
            return e;
          },
          v = function (e, t) {
          ...
          b = function (e) {
            ...
            e &&
              ((g.context.showPiecesInfo =
                ...
                !(!t || 'never' === a) &&
                  ('le102400' === a ? t.numPieces <= 102400 : 'le10240' === a ? t.numPieces <= 10240 : 'le1024' !== a || t.numPieces <= 1024))),
              ...
              (g.task && g.task.status === e.status) ||
                (g.context.availableOptions =
                  ((n = e.status), (i = !!e.bittorrent), (s = c.getAvailableTaskOptionKeys(n, i)), c.getSpecifiedOptions(s, { disableRequired: !0 }))),
              g.task && (delete g.task.verifiedLength, delete g.task.verifyIntegrityPending),
          ...
          y = function (e) {
            e &&
              (m.extendArray(e, g.context.btPeers, 'peerId') || (g.context.btPeers = e),
              (g.context.healthPercent = s.estimateHealthPercentFromPeers(g.task, g.context.btPeers)));
          },
          k = function (e) {
            ...
            if (e) {
              ...
              if (e.subDirs && e.subDirs.length)
                for (n = 0; n < e.subDirs.length; n++) {
                  var i = e.subDirs[n];
                  T(i), (t += i.selected ? 1 : 0), (a += i.partialSelected ? 1 : 0);
                }
              (e.selected = 0 < t && t === e.subDirs.length + e.files.length), (e.partialSelected = (0 < t && t < e.subDirs.length + e.files.length) || 0 < a);
            }
          },
          C = function () {
        ...
        (g.context = {
          ...
          (g.changeTab = function (e) {
            'settings' === e && g.loadTaskOption(g.task), (g.context.currentTab = e);
          }),
          ...
          (g.changeFileListDisplayOrder = function (e, t) {
            if (!g.task || !g.task.multiDir) {
              ...
              t && n.type === a.type && (n.reverse = !a.reverse), r.setFileListDisplayOrder(n.getValue());
            }
          }),
          ...
          (g.getFileListOrderType = function () {
            return g.task && g.task.multiDir ? null : r.getFileListDisplayOrder();
          }),
          (g.showChooseFilesToolbar = function () {
            g.context.showChooseFilesToolbar ? g.cancelChooseFiles() : ((u = !0), (g.context.showChooseFilesToolbar = !0));
          }),
            ...
            if (g.task && g.task.files && f[e]) {
              for (var t = g.task.files, a = f[e].extensions, n = [], i = !0, s = 0; s < t.length; s++) {
                if (!(r = t[s]).isDir) {
                  ...
                  o && (o = o.toLowerCase()), 0 <= a.indexOf(o) && (n.push(s), r.selected || (i = !1));
                }
              }
          ...
          (g.saveChoosedFiles = function () {
            g.context.showChooseFilesToolbar && ((o.loadPromise = S(!1)), (g.context.showChooseFilesToolbar = !1));
          }),
          (g.cancelChooseFiles = function () {
            g.context.showChooseFilesToolbar && (w(!(u = !1)), (g.context.showChooseFilesToolbar = !1));
          }),
          (g.showCustomChooseFileModal = function () {
            if (g.task && g.task.files) {
              for (var e = g.task.files, t = {}, a = 0; a < e.length; a++) {
                var n = e[a];
                if (!n.isDir) {
                  if (((u = m.getFileExtension(n.fileName)) && (u = u.toLowerCase()), !(p = t[u]))) {
                    var i = u;
                  ...
                  n.selected ? ((p.selected = !0), p.selectedCount++) : p.unSelectedCount++;
                }
              }
              var s = {};
              for (var o in f)
          ...
          (g.collapseDir = function (e, t, a) {
            var n = e.nodePath;
            if ((angular.isUndefined(t) && (t = !g.context.collapsedDirs[n]), t || a))
              for (var i = 0; i < e.subDirs.length; i++) g.collapseDir(e.subDirs[i], t);
          ...
          (g.setSelectedNode = function (e) {
            x(e, e.selected), C(), g.context.showChooseFilesToolbar || g.setSelectedFile(!1);
          }),
          (g.changePeerListDisplayOrder = function (e, t) {
            var a = m.parseOrderType(r.getPeerListDisplayOrder()),
              n = m.parseOrderType(e);
            t && n.type === a.type && (n.reverse = !a.reverse), r.setPeerListDisplayOrder(n.getValue());
          }),
          ...
          0 < r.getDownloadTaskRefreshInterval() &&
            (d = t(function () {
              !g.task || ('complete' !== g.task.status && 'error' !== g.task.status && 'removed' !== g.task.status) ? w(!0) : t.cancel(d);
    ...
    angular.module('ariaNg').controller('AriaNgSettingsController', [
      ...
      function (t, n, e, a, i, s, o, r, l, c, d, u, p, g, f, m, h, v, b) {
        var y = e.extendType,
          ...
          S = function () {
            if (!n.context || !n.context.rpcSettings || n.context.rpcSettings.length < 1) return null;
        ...
        (n.context = {
          ...
          (t.swipeActions.extendLeftSwipe = function () {
            var e = -1;
            return n.isCurrentGlobalTab() || (e = parseInt(n.getCurrentRpcTabIndex())), e < n.context.rpcSettings.length - 1 && (n.changeRpcTab(e + 1), !0);
          }),
          (t.swipeActions.extendRightSwipe = function () {
            var e = -1;
            return (
              n.isCurrentGlobalTab() || (e = parseInt(n.getCurrentRpcTabIndex())), 0 < e ? (n.changeRpcTab(e - 1), !0) : 0 === e && (n.changeGlobalTab(), !0)
            );
          }),
          ...
          (n.showImportSettingsModal = function () {
            (n.context.importSettings = null), angular.element('#import-settings-modal').modal();
          }),
          ...
          (n.importSettings = function (e) {
            ...
            try {
              ...
              return g.error('[AriaNgSettingsController.importSettings] parse settings json error', e), void p.showError('Invalid settings data format!');
            }
            if (!angular.isObject(t) || angular.isArray(t))
              return g.error('[AriaNgSettingsController.importSettings] settings json is not object'), void p.showError('Invalid settings data format!');
            t &&
              p.confirm('Confirm Import', 'Are you sure you want to import all settings?', 'warning', function () {
          ...
          $('#export-settings-modal').on('hide.bs.modal', function (e) {
            (n.context.exportSettings = null), (n.context.exportSettingsCopied = !1);
          }),
          ...
          (n.addNewRpcSetting = function () {
            ...
            n.context.rpcSettings.push(e), n.changeRpcTab(n.context.rpcSettings.length - 1);
          }),
      ...
      function (e, t, a, n, i) {
        (t.context = {
          ...
          (e.loadPromise = i.getAria2Status(function (e) {
            e.success ? ((t.context.status = 'Connected'), (t.context.serverStatus = e.data)) : (t.context.status = 'Disconnected');
          }));
      },
    ]);
  })(),
          ...
          link: function (c, d) {
            var e = function () {
              var e = d[0],
                ...
                a = e.getContext('2d');
              (a.fillStyle = c.color || '#000'), a.clearRect(0, 0, e.width, e.height);
              for (var n = 0, i = e.width, s = e.height, o = 0; o < t.length; o++) {
                var r = t[o],
        ...
        return {
          ...
          link: function (n, i) {
            var s = [],
              o = [],
              a = function () {
                (o = r.getPieceStatus(n.bitField, n.pieceCount)), (s.length = 0), i.empty();
                for (var e = Math.max(1, o.length), t = 0; t < e; t++) {
                  var a = angular.element('<div class="piece' + (o[t] ? ' piece-completed' : '') + '"></div>');
                  s.push(a), i.append(a);
                }
              };
            n.$watch('bitField', function () {
              !(function () {
                ...
                if (o && e && o.length === e.length && e.length === s.length) {
                  for (var t = 0; t < s.length; t++) o[t] !== e[t] && (e[t] ? s[t].addClass('piece-completed') : s[t].removeClass('piece-completed'));
                  o = e;
                } else a();
              })();
            }),
            ...
            link: function (n, e, i) {
              ...
              e.popover({
                ...
                .on('shown.bs.popover', function () {
                  ...
                  e.css('height', a + 'px'), (s = echarts.init(e[0], o.get(n.theme)));
                })
          ...
          link: function (s, i, e, t) {
              ...
              d = function (e) {
                return 'Bytes' === s.option.suffix
                  ? (function (e) {
                      ...
                      for (var t = ['', 'K', 'M', 'G'], a = 0, n = 0; n < t.length && !(e < 1024 || e % 1024 != 0); n++) (e /= 1024), a++;
                      return e + t[a];
                    })(e)
                  : e;
              };
            (s.optionStatus =
              ...
              (s.changeValue = function (e, t) {
                if ((o && u.cancel(o), (s.optionValue = e), s.optionStatus.setReady(), s.option && s.option.key && !s.option.readonly))
                  if (s.option.required && '' === e) s.optionStatus.setError('Option value cannot be empty!');
                  else if ('' === e || 'integer' !== s.option.type || /^-?\d+$/.test(e))
                    if ('' === e || 'float' !== s.option.type || /^-?(\d*\.)?\d+$/.test(e)) {
                      if (
                        '' !== e &&
                        ('integer' === s.option.type || 'float' === s.option.type) &&
                        (angular.isDefined(s.option.min) || angular.isDefined(s.option.max))
                      ) {
                        var a = e;
                        if (
                          ('integer' === s.option.type ? (a = parseInt(e)) : 'float' === s.option.type && (a = parseFloat(e)),
                          angular.isDefined(s.option.min) && a < s.option.min)
                        )
                          return void s.optionStatus.setError('Input number is below min value!', { value: s.option.min });
                        if (angular.isDefined(s.option.max) && a > s.option.max)
                          return void s.optionStatus.setError('Input number is above max value!', { value: s.option.max });
                      }
              ...
              (s.filterHistory = function (e) {
                var t = [];
                if (s.history && e) for (var a = 0; a < s.history.length; a++) 0 === s.history[a].indexOf(e) && t.push(s.history[a]);
                return p.resolve(t);
              }),
              t &&
                s.$watch(
        ...
        return {
          ...
          link: function (n, e, t) {
            ...
            angular.element('#quickSettingModal').on('hidden.bs.modal', function () {
              (n.setting = null), (n.context.availableOptions = []), (n.context.globalOptions = []);
            }),
              n.$watch(
                'setting',
                function (e) {
                  ...
                  e &&
                    ...
                    s.getGlobalOption(function (e) {
                      (n.context.isLoading = !1), e.success && (n.context.globalOptions = e.data);
                    }),
        ...
        link: function (e, t, a) {
          ...
          i && s(),
            ...
            e.$watch('ngTooltipIf', function (e) {
              angular.isUndefined(e) || (i !== (e = !0 === e || 'true' === e) && (e ? s() : angular.element(t).tooltip('destroy'), (i = e)));
            });
        },
      };
    });
      ...
      function (r) {
        ...
        return function (e, t) {
          var a,
            ...
            i = 2,
            s = !1;
          angular.isNumber(t) ? (i = t) : 'auto' === t && (s = !0), e || (e = 0), angular.isNumber(e) || (e = parseInt(e));
          for (var o = 1; o < l.length && 1024 <= e; o++) (e /= 1024), (n = l[o]);
          return s && (i = (a = e) < 1 ? 2 : a < 10 ? 1 : 0), (e = r('number')(e, i)) + ' ' + n;
        };
      },
    ]);
  })(),
      ...
      function () {
        ...
        (this.getLanguageAsset = function (e) {
          ...
          (this.setLanguageAsset = function (e, t) {
            !(function (e, t) {
              for (var a = e.split('.'), n = s, i = 0; i < a.length - 1; i++) angular.isUndefined(n[a[i]]) && (n[a[i]] = {}), (n = n[a[i]]);
              n[a[a.length - 1]] = t;
            })(a + e, t);
          }),
          (this.$get = function () {
      ...
      function (o, r, l, c, d, u, p, g, f) {
        var m = function (e) {
          ...
          h = function (e, t) {
            var a = e;
            if (!t) return a;
            if (('[' === t[0] && ']' === t[t.length - 1] && (t = t.substring(1, t.length - 1)), 'global' === t)) return a;
          ...
          v = function (e) {
            ...
            for (var a = e.split('\n'), n = t, i = 0; i < a.length; i++) {
              var s = a[i];
              if (s)
                if (((s = s.replace('\r', '')), /^\[.+\]$/.test(s))) n = h(t, s);
                else {
                  var o = m(s);
            ...
            o({ url: a, method: 'GET' })
              .then(function (e) {
                ...
                return (
                  ...
                  f.set(i, t),
                  a
                    ? (g.info('[ariaNgLanguageLoader] load language resource successfully, and resource is updated'),
              ...
              .catch(function (e) {
                return (
                  ...
                  s || u.notifyInPage('', 'AriaNg cannot get language resources, and will display in default language.', { type: 'error', delay: !1 }),
                  n.reject(t.key)
                );
              }),
            n.promise
      ...
      function (e, s, t, a, r, n) {
        return {
          ...
          getTimeOptions: function (e, t) {
            var a = [];
            if ((t && a.push({ name: 'Disabled', value: 0, optionValue: 0 }), !angular.isArray(e) || e.length < 1)) return a;
          ...
          notifyViaBrowser: function (e, t, a) {
            ...
            a || (a = {}),
              ...
              r &&
                ...
                ((n = e), (i = a), s.Notification && l(c()) && ((i = angular.extend({ icon: 'tileicon.png' }, i)), new s.Notification(n, i)));
          },
          notifyInPage: function (e, t, a) {
            return a || (a = {}), t ? ((a.title = e), (a.message = t)) : (a.message = e), (a.type && n[a.type]) || (a.type = 'primary'), n[a.type](a);
          },
    ...
    angular.module('ariaNg').factory('ariaNgLocalizationService', [
      ...
      function (a, t, o, n) {
        return {
          ...
          notifyViaBrowser: function (e, t, a) {
            return e && (e = this.getLocalizedText(e)), t && (t = this.getLocalizedText(t)), n.notifyViaBrowser(e, t, a);
          },
          notifyInPage: function (e, t, a) {
            return (
              a || (a = {}),
              e && (e = this.getLocalizedText(e, a.titleParams)),
              t && ((t = this.getLocalizedText(t, a.contentParams)), a.contentPrefix && (t = a.contentPrefix + t)),
      ...
      function (a, o) {
        var r = !1,
          ...
          n = function (e, t, a) {
            var n, i, s;
            r &&
              (l.length >= o.cachedDebugLogsLimit && l.shift(), l.push(((n = e), (i = t), (s = a), { time: new Date(), level: i, content: n, attachment: s })));
          };
        return {
          ...
          debug: function (e, t) {
            r && (t ? a.debug('[AriaNg Debug]' + e, t) : a.debug('[AriaNg Debug]' + e), n(e, 'DEBUG', t));
          },
          info: function (e, t) {
            t ? a.info('[AriaNg Info]' + e, t) : a.info('[AriaNg Info]' + e), n(e, 'INFO', t);
          },
          warn: function (e, t) {
            t ? a.warn('[AriaNg Warn]' + e, t) : a.warn('[AriaNg Warn]' + e), n(e, 'WARN', t);
          },
          error: function (e, t) {
            t ? a.error('[AriaNg Error]' + e, t) : a.error('[AriaNg Error]' + e), n(e, 'ERROR', t);
          },
      ...
      function (e, i) {
        return {
          ...
          keys: function (e) {
            ...
            for (var a = [], n = 0; n < t.length; n++) 0 <= t[n].indexOf(e) && a.push(t[n]);
            return a;
          },
        };
      },
      ...
      function (n, t, e, i, o, s, r, l, c) {
        var a = {
          ...
          p =
            ...
            angular.isFunction(n.matchMedia('(prefers-color-scheme: dark)').addEventListener),
          g = [],
          f = [],
          m = !1,
          h = { debugMode: !1 };
        ...
        var v = function () {
          ...
          b = function (e) {
            for (var t in s)
              if (s.hasOwnProperty(t)) {
                ...
                var a = s[t].aliases;
                if (angular.isArray(a) && !(a.length < 1)) for (var n = 0; n < a.length; n++) if (a[n].toLowerCase() === e.toLowerCase()) return t;
              }
            return null;
          },
          y = function () {
            var e = n.navigator.browserLanguage ? n.navigator.browserLanguage : n.navigator.language;
            if (!e) return l.info('[ariaNgSettingService] cannot get browser language, use default language'), o.language;
            ...
            return s[e]
              ? (l.info('[ariaNgSettingService] use browser language "' + e + '" as current language'), e)
              : (l.info('[ariaNgSettingService] browser language "' + e + '" not support, use default language'), o.language);
          },
          k = function (e) {
          ...
          w = function () {
            ...
            if ((t && !s[t.language] && (t.language = ((e = t.language), b(e) || y())), !t)) {
              if ((((t = angular.extend({}, o)).language = y()), t.rpcHost || T(t), angular.isArray(t.extendRpcServers)))
          ...
          S = function (e) {
            var t = w();
            return angular.isUndefined(t[e]) && angular.isDefined(o[e]) && ((t[e] = o[e]), k(t)), t[e];
          },
          x = function (e, t) {
            var a = w();
            (a[e] = t), k(a);
          ...
          T = function (e) {
            (e.rpcHost = t.host() || i.defaultHost), v() && (e.protocol = i.defaultSecureProtocol);
          },
          C = function (e) {
            return {
              rpcAlias: e.rpcAlias,
        ...
        return {
          ...
          getAllOptions: function () {
            ...
            if ((e.secret && (e.secret = r.base64Decode(e.secret)), angular.isArray(e.extendRpcServers)))
          ...
          getAllRpcSettings: function () {
            ...
            if (((a.isDefault = !0), e.push(a), angular.isArray(t.extendRpcServers)))
              for (var n = 0; n < t.extendRpcServers.length; n++) {
                ...
                (i.rpcId = t.extendRpcServers[n].rpcId), (i.isDefault = !1), e.push(i);
              }
          ...
          importAllOptions: function (e) {
            ...
            for (var a in e) e.hasOwnProperty(a) && t.hasOwnProperty(a) && (angular.isObject(e[a]) || angular.isArray(e[a]) || (t[a] = e[a]));
            if (angular.isArray(e.extendRpcServers))
              for (var n = 0; n < e.extendRpcServers.length; n++) {
                var i = e.extendRpcServers[n],
                  s = P();
                for (var a in i) i.hasOwnProperty(a) && s.hasOwnProperty(a) && (angular.isObject(i[a]) || angular.isArray(i[a]) || (s[a] = i[a]));
          ...
          updateRpcSetting: function (e, t) {
            ...
            var n = a[t];
            if (('rpcPort' === t ? (n = Math.max(parseInt(n), 0)) : 'secret' === t && n && (n = r.base64Encode(n)), e.isDefault)) return x(t, n), e;
            var i = w();
          ...
          setDefaultRpcSetting: function (e, t) {
            ...
            var a = w(),
              n = C(a);
            (n.rpcId = r.generateUniqueId()), angular.isArray(a.extendRpcServers) || (a.extendRpcServers = []);
            ...
            return (
              t.forceSet && (i = C(e)).secret && (i.secret = r.base64Encode(i.secret)),
              i && (t.keepCurrent && a.extendRpcServers.splice(0, 0, n), (a = angular.extend(a, i))),
              k(a),
              e
            );
          },
              ...
              var t = {
                  ...
                  tooltip: {
                    ...
                    formatter: function (e) {
                      if ('' === e[0].name) return '<div>' + r.getLocalizedText('No Data') + '</div>';
  ...
  (function () {
    ...
    angular.module('ariaNg').factory('ariaNgTitleService', [
      ...
      function (d, f, m, h) {
        var u = function (e) {
            if (!e) return {};
            for (var t = e.substring(2, e.length - 1).split(':'), a = { oldValue: e }, n = 1; n < t.length; n++) {
              var i = t[n].split('=');
          ...
          v = function (e, t, a) {
            var n,
              i,
              s,
              o = new RegExp('\\$\\{' + t + '(:[a-zA-Z0-9]+(=[a-zA-Z0-9]+)?)*\\}', 'g'),
              r = e.match(o);
            if (r && 0 < r.length)
              ...
              return (
                      ...
                      for (var n in t)
                        if (t.hasOwnProperty(n)) {
                          ...
                          null === i ||
                            ...
                            (0 < a.length && (a += '&'),
                            (angular.isObject(i) || angular.isArray(i)) && ((i = angular.toJson(i)), (i = s.base64Encode(i)), (i = encodeURIComponent(i))),
                            (a += n + '=' + i));
                        }
                      return a.length < 1 ? e : ((a = e.indexOf('?') < 0 ? '?' + a : '&' + a), e + a);
                    })(e.url, a.requestBody)),
                ...
                t(e)
                  .then(function (e) {
                    var t = e.data;
                    n.debug(
                      '[aria2HttpRpcService.request] ' + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + ' ' : '') + 'response success',
                      e
                    ),
                      t &&
                        (a.connectionSuccessCallback && a.connectionSuccessCallback({ rpcUrl: i, method: o }),
                        a.successCallback && a.successCallback(t.id, t.result));
                  })
                  .catch(function (e) {
                    var t = e.data;
                    n.debug(
                      '[aria2HttpRpcService.request] ' + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + ' ' : '') + 'response error',
                      e
                    ),
                      t || ((t = { id: '-1', error: { innerError: !0 } }), a.connectionFailedCallback && a.connectionFailedCallback({ rpcUrl: i, method: o })),
                            ...
                            if (t) {
                              ...
                              if (a) {
                                ...
                                a.deferred.resolve({ success: !0, context: n }),
                                  e.result && n.connectionSuccessCallback && n.connectionSuccessCallback({ rpcUrl: i }),
                                  e.result &&
                                    n.successCallback &&
                                    (o.debug(
                                      '[aria2WebSocketRpcService.request] ' +
                                        (n && n.requestBody && n.requestBody.method ? n.requestBody.method + ' ' : '') +
                                        'response success',
                                      e
                                    ),
                          ...
                          (function (e) {
                            ...
                            if (t) {
                              ...
                              if (angular.isArray(a) && !(a.length < 1))
                                for (var n = 0; n < a.length; n++) (0, a[n])(angular.isArray(e.params) && 0 < e.params.length ? e.params[0] : null);
                            }
                          })(t));
                  }
                }),
                  n.onOpen(function (e) {
                    o.debug('[aria2WebSocketRpcService.onOpen] websocket is opened', e),
                      t && t.connectionSuccessCallback && t.connectionSuccessCallback({ rpcUrl: i });
                  }),
                  n.onClose(function (e) {
                    o.warn('[aria2WebSocketRpcService.onClose] websocket is closed', e),
                      t && t.connectionFailedCallback && t.connectionFailedCallback({ rpcUrl: i });
                  });
              } catch (e) {
                return {
                  success: !1,
        ...
        return {
          request: function (e) {
            if (e) {
              ...
              o.debug(
                '[aria2WebSocketRpcService.request] ' + (e && e.requestBody && e.requestBody.method ? e.requestBody.method + ' ' : '') + 'request start',
                e
              );
              var i = s.defer();
              return (
                ...
                t.instance
                  ...
                  : (i.reject({ success: !1, context: e }),
                    o.debug('[aria2WebSocketRpcService.request] client error', t),
      ...
      function (l, o, r, i, s, c, d, u, e, t) {
        var p = u.isCurrentRpcUseWebSocket() ? t : e,
          ...
          O = function () {
            ...
            if ((f && !t && a.push(o.rpcTokenPrefix + f), 1 < arguments.length)) {
              var i = arguments[1];
              (n.successCallback = function (e, t) {
                if ((i.callback && i.callback({ id: e, success: !0, data: t, context: i }), D(h), !g)) {
                  g = !0;
                ...
                (n.errorCallback = function (e, t) {
                  ...
                  i.silent ||
                    (n = !(
                      !(a = t) ||
                      !a.message ||
                      (d.error('[aria2RpcService.processError] ' + a.message, a),
                      r[a.message] && r[a.message].tipTextKey ? c.showError(r[a.message].tipTextKey) : c.showError(a.message),
                      0)
                    )),
                    i.callback &&
                      i.callback({
            ...
            if (2 < arguments.length)
              for (var s = 2; s < arguments.length; s++) null !== arguments[s] && angular.isDefined(arguments[s]) && a.push(arguments[s]);
            return 0 < a.length && (n.params = a), n;
          },
          R = function (e, t) {
            var a = angular.copy(e);
            for (var n in a) a.hasOwnProperty(n) && N(a, n) && (a[n] = I(a[n], i[n]));
        ...
        return (
          ...
          P('onBtDownloadComplete', x),
          {
            ...
            getFullTaskParams: function () {
              ...
              return e.push('files'), e.push('bittorrent'), e.push('infoHash'), e;
            },
            addUri: function (e, t) {
              var a = e.task.urls,
            ...
            forceRemoveMulti: function (e) {
              for (var t = [], a = 0; a < e.gids.length; a++) t.push({ silent: !!e.silent, gid: e.gids[a] });
  ...
  (function () {
    ...
    angular.module('ariaNg').factory('aria2TaskService', [
      ...
      function (u, m, l, y, p, k, w, S, g) {
        var x = function (e) {
            if (!e) return S.warn('[aria2TaskService.getFileName] file is null'), '';
            var t = e.path,
              a = !1;
            !t && e.uris && 0 < e.uris.length && ((t = e.uris[0].uri), (a = !0));
            var n = t.lastIndexOf('/');
            ...
            if ((0 < s && (o = i.substring(0, s)), a))
              try {
                ...
                S.warn('[aria2TaskService.getFileName] failed to url decode file name, original file name: ' + o, e);
              }
            return o;
          },
          T = function (e, t) {
            var a = e.dir,
              n = t.path;
            a && (a = a.replace(/\\/g, l.defaultPathSeparator)), n && (n = n.replace(/\\/g, l.defaultPathSeparator));
            var i = function () {
          ...
          c = function (e, t, a) {
            ...
            if (e.length) {
              ...
              0 < r && ((o = e.substring(0, r)), (s = e.substring(r + 1))), (i = c(o, t, a));
            }
            return (
              (n = {
                isDir: !0,
            ...
            if (e) {
              ...
              if (e.subDirs && e.subDirs.length)
                for (var o = 0; o < e.subDirs.length; o++) {
                  var r = e.subDirs[o];
                  a.push(r), P(r, t, a), (n += r.length), (i += r.selected ? 1 : 0), (s += r.partialSelected ? 1 : 0);
                }
              if (e.files && e.files.length)
          ...
          r = function (e, t) {
            if (!e) return S.warn('[aria2TaskService.processDownloadTask] task is null'), e;
            ...
            (e.totalLength = parseInt(e.totalLength)),
              ...
              (e.remainTime = ((a = e.remainLength), 0 === (n = e.downloadSpeed) ? 0 : a / n)),
            ...
            var s,
              ...
              c =
                ((r = !(o = '')),
                (s = e).bittorrent && s.bittorrent.info && (o = s.bittorrent.info.name),
            ...
            if (
              ...
              (e.errorDescription =
                (l = e).errorCode && y[l.errorCode] && y[l.errorCode].descriptionKey ? (y[l.errorCode].hide ? '' : y[l.errorCode].descriptionKey) : ''),
              e.files)
            ) {
            ...
            return S.debug('[aria2TaskService.processDownloadTask] process success', e), e;
          },
          d = function (e, t, a) {
            if (!e) return S.warn('[aria2TaskService.processBtPeers] peers is null'), e;
            for (var n = D(t.bitfield, t.numPieces), i = k.countArray(n, !0), s = t.completePercent, o = 0; o < e.length; o++) {
              var r = e[o],
              ...
              if (
                ...
                if (g && 'unknown' !== g.client) {
                  ...
                  (f.info = f.name + (f.version ? ' ' + f.version : '')), (r.client = f);
                }
              }
            }
        ...
        return {
          ...
          getTaskStatus: function (e, t, a, n) {
            return p.tellStatus({
              ...
              silent: !!a,
              callback: function (e) {
                t ? (e.success && r(e.data, n), t(e)) : S.warn('[aria2TaskService.getTaskStatus] callback is null');
              },
            });
          },
          ...
          setTaskOption: function (e, t, a, n, i) {
            var s = {};
            return (s[t] = a), p.changeOption({ gid: e, options: s, silent: !!i, callback: n });
          },
          selectTaskFile: function (e, t, a, n) {
            for (var i = '', s = 0; s < t.length; s++) 0 < i.length && (i += ','), (i += t[s]);
          ...
          getBtTaskPeers: function (t, a, e, n) {
            return p.getPeers({
              ...
              silent: !!e,
              callback: function (e) {
                a ? (e.success && d(e.data, t, n), a(e)) : S.warn('[aria2TaskService.getBtTaskPeers] callback is null');
              },
            });
          },
            ...
            return (
              ...
              p.multicall({
                ...
                callback: function (e) {
                  t
                    ? ((e.task = {}),
                      e.success && 0 < e.data.length && ((e.task = e.data[0][0]), r(e.task, s)),
                      e.success && e.task.bittorrent && 1 < e.data.length && ((e.peers = e.data[1][0]), d(e.peers, e.task, i)),
                      t(e))
                    : S.warn('[aria2TaskService.getTaskStatusAndBtPeers] callback is null');
                },
              })
            );
          },
          ...
          retryTask: function (s, o, r) {
            ...
            return (
              p.multicall({
                ...
                callback: function (e) {
                  if (o) {
                    if (!e.success) return S.warn('[aria2TaskService.retryTask] response is not success', e), l.reject(e), void o(e);
                    if (
                      ...
                      return (
                        c || S.warn('[aria2TaskService.retryTask] task is null'),
                    ...
                    p.addUri({
                      ...
                      silent: !!r,
                      callback: function (e) {
                        if (!e.success) return S.warn('[aria2TaskService.retryTask] addUri response is not success', e), l.reject(e), void o(e);
                  ...
                  } else S.warn('[aria2TaskService.retryTask] callback is null');
                },
              }),
              l.promise
            );
            ...
            if (s) {
              for (
                var t = this.retryTask,
                  ...
                  n = function (a, n) {
                    return (
                      S.debug('[aria2TaskService.retryTasks] task#' + n + ', gid=' + a.gid + ' start retrying', a),
                      t(
                        a.gid,
                        function (e) {
                          if (
                            (S.debug('[aria2TaskService.retryTasks] task#' + n + ', gid=' + a.gid + ', result=' + e.success, a),
                            e.success ? r++ : l++,
                            r + l === i.length)
                          ) {
                            var t = {
              ...
              0 < n.length &&
                o.push(
                  p.forceRemoveMulti({
                    ...
                    silent: !!a,
                    callback: function (e) {
                      k.pushArrayTo(c, e.results), (r = r || e.hasSuccess), (l = l || e.hasError);
                    },
                  })
                ),
              0 < i.length &&
          ...
          onConnectionSuccess: function (e) {
            e ? p.onConnectionSuccess({ callback: e }) : S.warn('[aria2TaskService.onConnectionSuccess] callback is null');
          },
          onConnectionFailed: function (e) {
            e ? p.onConnectionFailed({ callback: e }) : S.warn('[aria2TaskService.onConnectionFailed] callback is null');
          },
          onFirstSuccess: function (e) {
            e ? p.onFirstSuccess({ callback: e }) : S.warn('[aria2TaskService.onFirstSuccess] callback is null');
          },
          onOperationSuccess: function (e) {
            e ? p.onOperationSuccess({ callback: e }) : S.warn('[aria2TaskService.onOperationSuccess] callback is null');
          },
          onOperationError: function (e) {
            e ? p.onOperationError({ callback: e }) : S.warn('[aria2TaskService.onOperationError] callback is null');
          },
          ...
          processDownloadTasks: function (e, t) {
            if (angular.isArray(e)) for (var a = 0; a < e.length; a++) r(e[a], t);
            else S.warn('[aria2TaskService.processDownloadTasks] tasks is not array', e);
          },
          ...
          getCombinedPieces: function (e, t) {
            return (function (e, t) {
              for (var a = D(e, t), n = [], i = 0; i < a.length; i++) {
                var s = a[i];
                0 < n.length && n[n.length - 1].isCompleted === s ? n[n.length - 1].count++ : n.push({ isCompleted: s, count: 1 });
              }
              return n;
            })(e, t);
          },
          estimateHealthPercentFromPeers: function (e, t) {
            if (!e || e.numPieces < 1 || t.length < 1)
              return S.warn('[aria2TaskService.estimateHealthPercentFromPeers] tasks is null or numPieces < 1 or peers < 1', e), e.completePercent;
            ...
            for (s = 0; s < t.length; s++) {
              ...
              n < l ? ((n = l), (i = o.completePercent)) : l === n && o.completePercent > i && (i = o.completePercent);
            }
            var u = 0;
            if (0 < a.length)
              for (;;) {
                var p = !0;
                for (s = 0; s < a.length; s++) 0 < a[s] ? (u++, a[s]--) : (p = !1);
                if (!p) break;
              }
            if (u <= n) return i;
        ...
        return {
          ...
          getAvailableTaskOptionKeys: function (e, t) {
            for (var a = r.taskOptions, n = [], i = 0; i < a.length; i++) {
              ...
              (s.canShow && s.canShow.indexOf(e) < 0) ||
                ('http' === s.category && t) ||
                (('bittorrent' !== s.category || t) && (s.canUpdate && s.canUpdate.indexOf(e) < 0 && (o.readonly = !0), n.push(o)));
            }
            return n;
          },
          getNewTaskOptionKeys: function () {
            for (var e = r.taskOptions, t = [], a = 0; a < e.length; a++) {
              ...
              (n.canShow && n.canShow.indexOf('new') < 0) || (n.canUpdate && n.canUpdate.indexOf('new') < 0 && (i.readonly = !0), t.push(i));
            }
            return t;
          },
          getSpecifiedOptions: function (e, t) {
            ...
            for (var n = 0; n < e.length; n++) {
              ...
              if (angular.isObject(i)) {
                var l = i;
                (i = l.key), (s = !!l.readonly), (o = l.category), (r = !!l.showHistory);
              }
              var c = p[i];
              if (c) {
                if (
          ...
          getSettingHistory: function (e) {
            ...
            for (var t = c(e), a = l.get(t) || [], n = [], i = 0; i < Math.min(a.length, o.historyMaxStoreCount); i++) n.push(a[i]);
            return n;
          },
          addSettingHistory: function (e, t) {
            ...
            var a = c(e),
              ...
              i = [];
            i.push(t);
            for (var s = 0; s < Math.min(n.length, o.historyMaxStoreCount - 1); s++) n[s] !== t && i.push(n[s]);
            return l.set(a, i), i;
          },
          clearSettingsHistorys: function () {
            for (var e = l.keys(o.settingHistoryKeyPrefix + '.'), t = 0; t < e.length; t++) l.remove(e[t]);
          },
          getGlobalOption: function (e, t) {
          ...
          setGlobalOption: function (e, t, a, n) {
            var i = {};
            return (i[e] = t), s.changeGlobalOption({ options: i, silent: !!n, callback: a });
          },
            ...
            return s.getGlobalStat({
              ...
              callback: function (e) {
                if (a) {
                  ...
                  a(t);
                } else n.warn('[aria2SettingService.getGlobalStat] callback is null');
              },
            });
          },
          saveSession: function (e, t) {
